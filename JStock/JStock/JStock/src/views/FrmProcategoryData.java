...
public class FrmProcategoryData extends javax.swing.JDialog {
    ...
    public FrmProcategoryData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblFormName.setText("Category Data");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "lblCategory_L1", "lblCategory_L1", "lblCategory_L2", "lblCategory_Info"
            }
        ) {
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        pcm.showSearchTable_procategory(jTable1, model, txtSearch.getText().trim());
    ...
    private void btnDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDataActionPerformed
        pcm.showTbl_ProCategory(jTable1, model);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            if (evt.getClickCount() == 2) {
                ...
                FrmProCategory.cateid = Integer.parseInt(jTable1.getValueAt(index, 0).toString());
                FrmProCategory.txtcatel1.setText(jTable1.getValueAt(index, 1).toString());
                FrmProCategory.txtcatel2.setText(jTable1.getValueAt(index, 2).toString());
                FrmProCategory.txtCateInfo.setText(jTable1.getValueAt(index, 3).toString());
                dispose();
            }
        } catch (Exception e) {
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProcategoryData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmProcategoryData dialog = new FrmProcategoryData(new javax.swing.JFrame(), true);
