...
public class FrmProSizeData extends javax.swing.JDialog {
    ...
    public FrmProSizeData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblFormName.setText("Product Size");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "SizeName", "SizeName", "SizeDescriptions"
            }
        ) {
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(2).setMinWidth(450);
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
       psm.showSearchData(jTable1, model, txtSearch.getText());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        try {
            if (evt.getClickCount()==2){
                ...
                FrmProSize.txtsize.setText(jTable1.getValueAt(index, 1).toString().trim());
                FrmProSize.txtsizeDes.setText(jTable1.getValueAt(index, 2).toString().trim());
                FrmProSize.prosizeid = Integer.parseInt(jTable1.getValueAt(index, 0).toString());
                dispose();
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProSizeData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmProSizeData dialog = new FrmProSizeData(new javax.swing.JFrame(), true);
