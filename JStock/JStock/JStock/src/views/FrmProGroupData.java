...
public class FrmProGroupData extends javax.swing.JDialog {
    Connection c = module.getConnection();
    String sql, frm;
    DefaultTableModel model = new DefaultTableModel();
    ProGroup pg = new ProGroup();
    ProGroupManager pgm = new ProGroupManager();
    public FrmProGroupData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        lblFormName.setText("Group Data");
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        pgm.showSeachTbl_ProGroup(jTable1, model, txtSearch.getText().trim());
    ...
    private void btnDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDataActionPerformed
        pgm.showTbl_ProGroup(jTable1, model);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmProGroupData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmProGroupData dialog = new FrmProGroupData(new javax.swing.JFrame(), true);
